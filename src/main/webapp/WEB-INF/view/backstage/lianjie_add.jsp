...
<body>
<form name="opform" method="post" action="/add_link_form" onsubmit="javascript:return check();">
    <table width="80%" border="0" align="center" cellpadding="0" cellspacing="1" bordercolor="1" bgcolor="#9EC3F2" style="font-size:12px">
        <!--DWLayoutTable-->
        <tr>
            <td height="25" colspan="2" align="left" valign="middle" background="img/bg_titlebarr.gif"><span class="STYLE1">&nbsp;增加链接信息</span></td>
        </tr>
        ...
        <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F9FCFF"><input name="URL" type="text" id="jzc" maxlength="18"  required /></td>
        </tr>
    </table>
